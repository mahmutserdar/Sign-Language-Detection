...
#DATA_FOLDER = '../datasets/alphabetDataset' # Alphabet
#DATA_FOLDER = '../datasets/alphabetDatasetTesting' # Alphabet test
#DATA_FOLDER = '../datasets/numbersDataset' # Numbers
#DATA_FOLDER = '../datasets/numbersDatasetTesting' # Numbers test
#DATA_FOLDER = '../datasets/asl_alphabet_train' # Alphabet
